...
--
-- Host: localhost
-- Generation Time: Apr 09, 2025 at 09:39 PM
...
--
ALTER TABLE `application`
  MODIFY `applicationID` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `application_status_history`
--
ALTER TABLE `application_status_history`
  MODIFY `historyID` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `job`
  MODIFY `jobID` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `application_status_history`
  ADD CONSTRAINT `application_history_app` FOREIGN KEY (`applicationID`) REFERENCES `application` (`applicationID`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `job`
--
ALTER TABLE `job`
  ADD CONSTRAINT `job_admin` FOREIGN KEY (`adminID`) REFERENCES `admin` (`adminID`) ON DELETE CASCADE ON UPDATE CASCADE,
...
--
ALTER TABLE `student`
  ADD CONSTRAINT `student_branch` FOREIGN KEY (`branch`) REFERENCES `branch` (`branch`),
